...
class _BookingDaysScreenState extends State<BookingDaysScreen> {
  bool isMonthlyMode = false; // ئایا مانگانەیە یان هەفتانە؟
  ...
  @override
  Widget build(BuildContext context) {
    // دروستکردنی ڕۆژەکان بەپێی هەڵبژاردن (هەفتانە یان مانگانە)
    ...
    return Scaffold(
      ...
      body: Directionality(
        ...
        child: Column(
          children: [
            // بەشی کۆنتڕۆڵ و گۆڕینی نێوان هەفتانە و مانگانە
            Container(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            if (isBooked) {
              ...
              tileColor = isPaid ? Colors.green.shade200 : Colors.red.shade200;
              statusText = isPaid
              ...
              child: ListTile(
                ...
                onTap: () {
                  if (!isBooked) {
                    ...
                    _editOrDeleteBooking(dateKey, slot, bookingInfo!, dayData);
                  }
                },
              ),
            );
